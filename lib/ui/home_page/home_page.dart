...
class _HomePageState extends BaseState<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:  context.watch<HomePageViewMopdel>().wait==false?SingleChildScrollView(
  ...
  GestureDetector themeChangeWidget(BuildContext context) {
    return GestureDetector(
          ...
          child: Row(
            children: [
              Icon(
                  Provider.of<ThemeNotifier>(context, listen: false).currentTheme != AppThemeLight.instance?.theme?Icons.light_mode:Icons.dark_mode,
                color: Theme.of(context).colorScheme.primary,
              ),
              SizedBox(width: 10,)
